...
/*diag_log "::Life Client:: Intialisiere die Medic-System Variablen";
[] call compile PreprocessFileLineNumbers "core\medicalvars.sqf";
diag_log "::Life Client:: Medic-System Variablen initialisiert";*/
...
waitUntil{!isNil "DB_localChange"};
...
/*systemChat "LSRL-MedicalSystem :: Initialisiere...";
_handle = [] spawn compile preprocessFileLineNumbers "core\init_medicalSystem.sqf";
waitUntil {scriptDone _handle};
systemChat "LSRL-MedicalSystem :: Version 1.0.0.0";
systemChat "LSRL-MedicalSystem :: Erfolgreich Geladen!";*/
