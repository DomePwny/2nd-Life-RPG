...
if(isNil "DB_localChange") exitWith {[] execVM "dialog\player_display.sqf";};
...
{
	case 1: {life_paycheck = life_paycheck + 75;};
	case 2: {life_paycheck = life_paycheck + 5;};
	case 3: {life_paycheck = life_paycheck + 10;};
};
