...
switch (_yo) do {
	...
	case 1: 
	{
		...
		["PoliceDispatch","Notruf"] call BIS_fnc_showNotification;
	};
	...
	case 5: 
	{
		...
		["MedicalRequestEmerg","Notruf"] call BIS_fnc_showNotification;
	};
	...
	case 6: 
	{
		...
		["AdacMessage","Notruf"] call BIS_fnc_showNotification;
	};
