...
if(!(str(player) in ["cop_4"]) && !(lrl_copLeitstelle)) then {
	switch(__GETC__(life_coplevel)) do
	{
		...
		case 6: {life_paycheck = life_paycheck + 125;};
		case 7: {life_paycheck = life_paycheck + 150;};
		case 8: {life_paycheck = life_paycheck + 150;};
		case 9: {life_paycheck = life_paycheck + 150;};
		case 10: {life_paycheck = life_paycheck + 160;};
		case 11: {life_paycheck = life_paycheck + 170;};
		case 12: {life_paycheck = life_paycheck + 180;};
	};
} else {
