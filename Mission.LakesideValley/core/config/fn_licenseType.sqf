...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "bike": {_var = "license_civ_bike"};
			...
			case "ilgun": {_var = "license_civ_ilgun"}; //Firearm/gun license cost
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_bike": {_var = "bike"};
			...
			case "license_civ_ilgun": {_var = "ilgun"}; //Firearm/gun license cost
