...
switch(_shop) do
{
			...
			default {
				["LAC Laden",
					[
						...
						["SmokeShellRed","Injektionsbeutel",800],
						["Chemlight_yellow","Kartenlampe (Weiss)",40],
						["Chemlight_blue","Ohrstöpsel",1]
					]
				];
	...
	case "justiz_laden":
	{
		...
		{
			case (playerSide != east): {"Du bist kein LAC!"};
			case (__GETC__(life_adaclevel) <= 9): {"Du bist als LAC whitelisted, nicht als Justiz!"};
			default {
				["LAC Laden",
					[
	...
	case "cop_basic":
	{
		switch(true) do
		{
			...
			case (__GETC__(life_coplevel) == 2):
			{
				["Officer",
					[
						...
						["A3L_RedDot",nil,375],
						["optic_ACO_grn_smg","ACO-G MP",225],
						["optic_ACO_grn","ACO-G",250],
						
						["acc_flashlight",nil,110],
			...
			case (__GETC__(life_coplevel) == 3):
			{
				["Detective",
					[	
						...
						["gign_shield","Einsatzschild",1000],
						//["SUPER_flash",nil,300],
						["ACE_M84",nil,300],
						
						["acc_pointer_IR",nil,100],
						["optic_ACO_grn_smg","ACO-G MP",200],
						["optic_ACO_grn","ACO-G",200],
						["optic_MRCO",nil,400],
						["optic_Hamr",nil,400],
						["optic_DMS",nil,400],
						["optic_NVS",nil,500],
			...
			case (__GETC__(life_coplevel) >= 6):
			{
				["Lieutenant bis CoP",
					[
						["srifle_mas_lrr",nil,2750],
					//	["optic_mas_LRPS",nil,500],
					//	["muzzle_snds_B",nil,500],
						["10Rnd_mas_338_T_Stanag",nil,900],
		...
		switch(true) do
		{
			...
			case ((license_civ_rebel)):
			{
				...
				//TFAR + ACE + Standart
						...
						["Chemlight_blue","Ohrstöpsel",1]
					] //["arifle_SDAR_F","UW-Waffe",271000],["20Rnd_556x45_UW_mag","UW-Geschosse",1200],
				];
			};
		};
	};
