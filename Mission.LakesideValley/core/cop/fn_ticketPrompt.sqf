...
_control ctrlSetStructuredText parseText format["<t align='center'>Strafzettel: <t size='.8px'>Ich einen Strafzettel in Höhe von $%2<br/>ausgestellt bekommen und habe diesen auch gezahlt.</t></t>",_cop getVariable["realname",name _cop],_val];
