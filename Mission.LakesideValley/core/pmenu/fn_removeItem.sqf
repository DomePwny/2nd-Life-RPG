...
if(_ind != -1 && ([west,getPos player,50] call life_fnc_nearUnits) && playerSide == civilian) exitWith {};
if(player getVariable["restrained",true]) exitWith {hint localize "STR_Global_Restrained"};
