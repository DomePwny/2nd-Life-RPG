...
params [["_uid", "", [""]], ["_name", "", [""]], ["_money", 0, [""]], ["_bank", 15000, [""]], ["_returnToSender", objNull, [objNull]],
...
_query = format["INSERT INTO players (playerid, name, cash, bankacc, aliases, cop_licenses, med_licenses, maf_licenses, civ_licenses, civ_gear, cop_gear, med_gear, maf_gear, arrestreason, bounties) VALUES('%1', '%2', '%3', '%4', '%5','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','%6','""[]""')",
	_uid,
	_name,
	_money,
	_bank,
