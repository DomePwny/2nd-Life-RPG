...
if((_unit getVariable ["life_is_arrested", false])) exitWith {["Diese Person ist bereits verhaftet.",20,"red"] spawn domsg;};
if(!(_unit getVariable ["restrained", false])) exitWith {["Die Person ist nicht festgenommen.",20,"red"] spawn domsg;}; 
