...
if (isNil "DYNMARKET_prices") then {[getPlayerUID player, false, false] remoteExecCall ["TON_fnc_playerLogged", call (life_fnc_HCC)]; ["Rufe Preise ab...", false] spawn domsg; sleep 1;};
