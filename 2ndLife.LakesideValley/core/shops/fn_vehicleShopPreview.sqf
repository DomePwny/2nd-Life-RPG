...
if(previewing_on) exitwith { ["Du betrachtest schon ein Fahrzeug", false] spawn doquickmsg; };
previewing_on = true;
...
if(_spawnPoint isEqualTo "") exitWith {["Ein Fahrzeug befindet sich auf dem Spawn!", false] spawn domsg;};
_obj = ObjNull;
...
hint "Deine Vorschau wurde mit einem Roten Pfeil markiert!";
