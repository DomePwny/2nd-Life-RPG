...
switch (_shop) do
{
	...
	case "market": {["Market",["medkit","condom","bandage","water","tierope","bec","cigarette","rabbit","apple","redgull","tbacon","pickaxe","lockpick","fuelF","peach","boltcutter","storagesmall","storagebig"]]};
	...
	case "cop": {["Cop Item Shop",["medkit","genitalcreme","panicbutton","bandage","fuelF","defusekit","BarGate","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB"]]};
