...
if(_target getVariable ["CPR",ObjNull] == player) exitWith {["Jemand stabilisiert diese Person...", false] spawn domsg;};
...
_titleText ctrlSetText format["Stabilisiere Person (1%1)...","%",_title];
...
while {true} do
{
	...
	_titleText ctrlSetText format["Stabilisiere Person (%1%2)...",round(_cP * 100),"%",_title];
