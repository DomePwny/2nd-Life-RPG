...
_titleText ctrlSetText format["Wiederbelebe (1%1)...","%",_title];
...
while {true} do
{
	...
	_titleText ctrlSetText format["Wiederbelebe (%1%2)...",round(_cP * 100),"%",_title];
...
[format["Du hast %1 wiederbelebt und $%2 für deine Dienste erhalten.",_targetName,[(call life_revive_fee)] call life_fnc_numberText], false] spawn domsg;